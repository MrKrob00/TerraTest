...
const ACTIVE_RING := Color(0.28, 0.55, 0.95)
...
# Кольца-категории — МЕРИДИАНЫ на общей вертикальной оси (как в прототипе-«атоме»), концентричны
# в центре: поворот всей конструкции на AZ переводит меридианы друг в друга (та же фигура).
