...
##
## 2048² не влезало: 16 МБ результата плюс три padded-буфера прохода по 16.8 МБ — пик под 67 МБ,
## и на Adreno 610 resize отдавал пустой массив. Тогда мира не было вовсе. 1024² это 4.2 МБ
## результата и около 17 МБ пика, зато полосы считаются чаще — что дешевле, а не дороже.
