...
@export var surface_material: Material = preload("res://addons/terrain_sculpt/terrain_shader.res")
...
@export_file("*.res", "*.exr", "*.png") var heightmap_path: String = "res://addons/terrain_sculpt/terrain_height.res"
