...
## ПАУЗА МЕЖДУ ЗАЛПАМИ. Была секунда, и это делало мортиру самым сильным стволом в игре с
## четырёхкратным отрывом: восемь снарядов по 12 — это 96 урона в секунду против 25 у пушки и 75
## у целой сборки крушителя. Машина под навесом рассыпалась быстрее, чем игрок успевал понять,
## откуда прилетело. Залп остался залпом (восемь снарядов разом — это её лицо), редкость залпа и
## есть её цена: 40 в секунду, в ряду с тяжёлыми стволами, а не вместо них.
const SALVO_PERIOD := 2.4
